...
public class CustomHotBarModule extends Module implements Draggable {
    ...
    public void onEnable() {
        if (x == -1 || y == -1) {
            ...
            y = scaledResolution.getScaledHeight() / 2 + 90;
        }
    }
    ...
    public void onRender(EventRender2D event) {
        ...
        if (mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            int scaledWidthMinus = event.getScaledResolution().getScaledWidth() / 2 - 91;
            int scaledWidthPlus = event.getScaledResolution().getScaledWidth() / 2 + 91;
            int scaledHeight = event.getScaledResolution().getScaledHeight() - 39;
            ...
            if (entity == null && mc.playerController.shouldDrawHUD()) {
            ...
            if (entityplayer.isInsideOfMaterial(Material.water) && mc.playerController.shouldDrawHUD()) {
        ...
        if (i > 0 && mc.playerController.shouldDrawHUD()) {
            short short1 = 182;
        ...
        if (mc.thePlayer.experienceLevel > 0 && mc.playerController.shouldDrawHUD()) {
        ...
        GlStateManager.popMatrix();
        setDraggableSize(new Vector2f(180, 20));
    }
