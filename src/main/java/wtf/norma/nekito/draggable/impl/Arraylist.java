    ...
    public Vector2f Render() {
        ...
        if(X < sr.getScaledWidth()/2.0f) {
            for(Module m : enabledMods) {
                ...
                Fonts.SEMI_BOLD_16.drawString(m.getName(),X,offset+2, OpenGlHelper.rainbowColor(3000, 1 + offset * 22));
                offset+=10;
            }
            ...
            for(Module m : enabledMods) {
                ...
                Fonts.SEMI_BOLD_16.drawString(m.getName(),X-Fonts.SEMI_BOLD_16.getStringWidth(m.getName()),offset+2, OpenGlHelper.rainbowColor(3000, 1 + offset * 22));
                offset+=10;
            }
