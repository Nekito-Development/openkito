...
import wtf.norma.nekito.util.filter.filter.math.Function2D;
import wtf.norma.nekito.util.filter.filter.math.ImageFunction2D;
import wtf.norma.nekito.util.filter.filter.vecmath.Color4f;
import wtf.norma.nekito.util.filter.filter.vecmath.Vector3f;
