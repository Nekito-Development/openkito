...
public class    UUIDFetcherUtils {
    ...
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        try {
            ...
            UUIDFetcherUtils data = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDFetcherUtils.class);
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            ...
            connection.setReadTimeout(5000);
            UUIDFetcherUtils[] nameHistory = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDFetcherUtils[].class);
