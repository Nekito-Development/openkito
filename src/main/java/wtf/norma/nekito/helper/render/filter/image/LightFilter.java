...
import wtf.norma.nekito.helper.render.filter.math.Function2D;
import wtf.norma.nekito.helper.render.filter.math.ImageFunction2D;
import wtf.norma.nekito.helper.render.filter.vecmath.Color4f;
import wtf.norma.nekito.helper.render.filter.vecmath.Vector3f;
