...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        MotionUpdateEvent motionUpdateEvent = new MotionUpdateEvent(EventState.PRE, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        motionUpdateEvent.post();

        if (motionUpdateEvent.isCancelled()) {
            motionUpdateEvent = new MotionUpdateEvent(EventState.POST, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            motionUpdateEvent.post();
            return;
        }

        //TODO: Dalsza implementacje sobie sami pierdoleniecie
